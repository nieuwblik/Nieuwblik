...
-- is, en dat zat nergens vast. Een vinkje per project is genoeg: het is een
-- ja-of-nee, en de rest van de stack is voor ons overal hetzelfde.
...
COMMENT ON COLUMN public.projects.built_with_tanstack IS
  'Aangevinkt wanneer de site op TanStack is gebouwd in plaats van op de standaardopzet.';
