            ...
            >
              ...
              >
                ...
                <div className="space-y-4 relative z-10">
                  {/* Dezelfde knoppen als op de rest van de site. Maat default in
                      plaats van lg: in deze smalle kolom brak het telefoonnummer
                      anders over twee regels. */}
                  <AnimatedButton href="tel:+31646253607" variant="outlineWhite" showArrow={false} className="w-full min-h-[44px] whitespace-nowrap">
                    <Phone className="mr-2 h-4 w-4 inline -mt-0.5" />
                    +31 6 46 25 36 07
                  </AnimatedButton>

                  <AnimatedButton href="https://wa.me/31646253607" variant="outlineWhite" showArrow={false} className="w-full min-h-[44px] whitespace-nowrap">
                      <svg className="mr-2 h-4 w-4 inline -mt-0.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
