...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section ref={heroAnimation.ref} className={`relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden transition-all duration-1000 ${heroAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-6">
              ...
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500 w-full lg:flex-1">
                <img src={justinImage} alt="Justin Slok - Nieuwblik" width="800" height="600" loading="eager" fetchPriority="high" className="w-full h-full object-cover" />
              </div>
              <div className="relative z-10 flex flex-row lg:flex-col gap-4 justify-center lg:justify-start">
                <a href="https://x.com/justin_slok" target="_blank" rel="noopener noreferrer" className="bg-background hover:bg-accent hover:text-accent-foreground p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110" aria-label="X (Twitter)">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </a>
                <a href="https://www.linkedin.com/in/justin-slok-b8a3011b2/" target="_blank" rel="noopener noreferrer" className="bg-background hover:bg-accent hover:text-accent-foreground p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110" aria-label="LinkedIn">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a href="https://wa.me/31646253607" target="_blank" rel="noopener noreferrer" className="p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:opacity-80" style={{
      ...
      {/* Services Overview */}
      <section ref={servicesAnimation.ref} className={`py-20 md:py-32 bg-secondary transition-all duration-1000 delay-200 ${servicesAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => <div key={index} className="bg-background p-8 rounded-lg transition-all hover:shadow-lg hover:-translate-y-1 duration-300" style={{
      ...
      <section ref={projectsAnimation.ref} className={`py-20 md:py-32 transition-all duration-1000 delay-300 ${projectsAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-12">
            {featuredProjects.map((project, index) => <ProjectCard key={index} title={project.title} category={project.category} description={project.description} image={project.image} url={project.url} tags={project.tags} />)}
          </div>
      ...
      <section ref={seoAnimation.ref} className={`py-20 md:py-32 bg-accent transition-all duration-1000 delay-300 ${seoAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
        <div className="container mx-auto px-6">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="flex flex-col items-center gap-2 group animate-fade-in hover:scale-110 transition-all duration-300" style={{
                  animationDelay: '0ms'
                }}>
                    <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center animate-float" style={{
                    animationDelay: '0ms'
                  }}>
                ...
                <TooltipTrigger asChild>
                  ...
                  animationDelay: '200ms'
                    ...
                    animationDelay: '400ms'
                      ...
                      <img src={perplexityLogo} alt="Perplexity AI" width="80" height="80" loading="lazy" className="w-full h-full object-contain" />
                    </div>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
                ...
                <TooltipTrigger asChild>
                  ...
                  animationDelay: '300ms'
                    ...
                    animationDelay: '600ms'
                      ...
                      <img src={grokLogo} alt="Grok (X AI)" width="80" height="80" loading="lazy" className="w-full h-full object-contain" />
                    </div>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
                ...
                <TooltipTrigger asChild>
                  ...
                  animationDelay: '400ms'
                    ...
                    animationDelay: '800ms'
                      ...
                      <img src={claudeLogo} alt="Claude AI" width="80" height="80" loading="lazy" className="w-full h-full object-contain" />
                    </div>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
                ...
                <TooltipTrigger asChild>
                  ...
                  animationDelay: '500ms'
                    ...
                    animationDelay: '1000ms'
                      ...
                      <img src={copilotLogo} alt="Microsoft Copilot" width="80" height="80" loading="lazy" className="w-full h-full object-contain" />
                    </div>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
          ...
          <div className="text-center mt-12 md:mt-16">
            ...
            <Button asChild size="lg" variant="secondary" className={`transition-all duration-700 delay-700 group ${seoAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}>
