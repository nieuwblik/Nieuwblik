          ...
          {isLoading ? (
            ...
            <div className="max-w-4xl mx-auto text-center transition-all duration-1000">
              <div className="mb-8 inline-block relative">
                ...
                <Sparkles
                  className="w-8 h-8 text-accent/60 absolute -top-2 -right-2 animate-pulse"
              ...
              <h1 className="text-display mb-6">Nieuwe blog artikelen komen eraan</h1>

              <p className="text-xl md:text-2xl text-muted-foreground font-light leading-relaxed mb-8">
                We zijn bezig met het creëren van waardevolle content vol tips, inzichten en strategieën om jouw
                digitale aanwezigheid naar een hoger niveau te tillen.
              </p>

              <div className="bg-secondary/50 border border-border rounded-2xl p-8 md:p-12 backdrop-blur-sm">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">Waar kun je op rekenen?</h2>
