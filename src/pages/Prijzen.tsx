...
const seoPaketten = [
  {
    ...
    period: "per maand",
    features: [
      "Basis hosting (domein + SSL via provider)",
      "Onbeperkte bandwidth & 2GB opslag",
      "Domeinnaam beheer (registratie + renewals)",
      "Basis SEO-audit met 3 keywords optimalisatie",
      "Maandelijks rapport & support (48u reactie)",
      "Mobielvriendelijke setup-check",
    ],
    description: "De makkelijke start: live gaan met solide basis voor jouw eerste online succes",
    buttonText: "Start Basis",
    href: "/sign-up",
    isPopular: false,
  },
  {
    ...
    period: "per maand",
    features: [
      "Uitgebreide hosting (multi-domein + CDN)",
      "Onbeperkte opslag & traffic",
      "Volledig domeinbeheer (incl. DNS-aanpassingen)",
      "Premium SEO met 15 keywords + on-page tweaks",
      "SEO-optimalisatie met Hadoseo integratie voor automatisering",
      "Content-tips (1 blog-idee/maand) & backlink advies",
      "Wekelijks monitoring & prioriteit support (24u)",
    ],
    description: "De sweet spot voor groei: meer traffic en posities zonder zorgen, met Hadoseo-power",
  ...
  },
  {
    ...
    price: "99",
    yearlyPrice: "79",
    period: "per maand (vanaf)",
    features: [
      "Alles in Premium + dedicated server-opties",
      "Enterprise hosting met top security",
      "Geavanceerd domeinbeheer (incl. custom redirects)",
      "Schaalbare SEO met Hadoseo-integratie",
      "Onbeperkt keywords + diepgaande concurrentie-analyse",
      "Maandelijkse content-strategie & linkbuilding plan",
      "Persoonlijke consultant & 1u support SLA",
    ],
    description: "Voor de grote sprong: onbeperkte schaal met slimme automatisering",
