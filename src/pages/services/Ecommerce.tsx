...
const Ecommerce = () => {
  ...
  const includedStandard = [
    "Complete e-commerce strategie",
    "Multichannel verkoop setup",
    "Marketplace integraties (Bol, Amazon)",
    "Marketing automation",
    "Voorraad & orderbeheer",
    "Conversie tracking & analytics",
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              { icon: ShoppingBag, label: "Eigen webshop" },
              { icon: Globe, label: "Bol.com" },
              { icon: Layers, label: "Amazon" },
              { icon: Users, label: "Social selling" },
              { icon: Megaphone, label: "Marketing" },
              { icon: Target, label: "Retargeting" },
              { icon: TrendingUp, label: "Analytics" },
              { icon: Repeat, label: "Automatisering" }
            ].map((item, index) => (
