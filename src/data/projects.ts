...
export const projects: Project[] = [
  ...
  },
  {
    ...
    detail: {
      year: "2026",
      goal: "Feigro Dakwerken timmert al jaren aan een naam als vakkundige dakdekker in Noord-Holland en Utrecht, maar de oude website deed dat vakmanschap geen recht. De opdracht was een site die in één oogopslag laat zien wat voor bedrijf dit is: geen kleine hobbyisten, maar een team dat platte en hellende daken op het hoogste niveau aanpakt. Daarnaast moest er onderscheid komen tussen twee heel verschillende soorten bezoekers. De ene komt oriënteren op een nieuw dak of een renovatie en heeft tijd nodig om een offerte aan te vragen. De andere staat met een lekkage in de woonkamer en wil binnen een paar tellen weten hoe die dat meldt. Beide moesten op de homepage direct hun weg vinden, zonder dat de een de ander in de weg zit.",
