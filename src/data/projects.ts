...
import bushidoshopImg from "@/assets/bushidoshop-portfolio-nieuw.webp";
...
export const projects: Project[] = [
  ...
  {
    slug: "feigro-dakwerken",
    title: "Feigro Dakwerken",
    ...
    detail: {
      year: "2026",
      goal: "Feigro Dakwerken is de nieuwe naam van Feitsma Dakwerken en Groen Dakwerken, twee gevestigde dakdekkersbedrijven uit Noord-Holland en Utrecht die hun krachten bundelden tot één bedrijf. Voor die nieuwe combinatie was een eigen, moderne website nodig die in één oogopslag laat zien wat voor bedrijf dit geworden is: geen twee aparte kleine spelers, maar één team dat platte en hellende daken op het hoogste niveau aanpakt. Daarnaast moest er onderscheid komen tussen twee heel verschillende soorten bezoekers. De ene komt oriënteren op een nieuw dak of een renovatie en heeft tijd nodig om een offerte aan te vragen. De andere staat met een lekkage in de woonkamer en wil binnen een paar tellen weten hoe die dat meldt. Beide moesten op de homepage direct hun weg vinden, zonder dat de een de ander in de weg zit.",
      idea: "Het ontwerp is gebouwd rond de vakman zelf: grootformaat fotografie van het team in actie, een stevige donkere basis met een fris groen accent, en een schuine lijn door de hero die de dynamiek van het werk terugbrengt op het scherm. De headline 'Meesters in Dakwerken' zet meteen de toon, zonder omhaal. Het belangrijkste ontwerpbesluit zat in de navigatie: naast de gebruikelijke offerteknop kreeg 'Lekkage melden' een eigen, opvallend plekje in de hoofdnavigatie. Voor Feigro is dat geen bijzaak maar een aanvraag met een heel andere urgentie, en dat verdiende een directe, eigen route in plaats van ergens weggestopt in een algemeen contactformulier.",
      details: "Voor Feigro Dakwerken, ontstaan uit de samenvoeging van Feitsma Dakwerken en Groen Dakwerken, heeft Nieuwblik in augustus 2026 een complete nieuwe website ontworpen en gebouwd voor het werkgebied Noord-Holland en Utrecht.\n\nDe homepage brengt in een paar seconden over waar Feigro voor staat: platte en hellende daken, onderhoud en renovatie, uitgevoerd door vakmensen die er met evenveel trots als precisie op staan. De projectenpagina toont opgeleverd werk als bewijs in plaats van belofte, en het nieuwsgedeelte houdt bezoekers op de hoogte van het bedrijf en de branche.\n\nOm het contactmoment zo laag mogelijk te houden zijn er twee losse routes: een offerteaanvraag voor wie een nieuw dak of renovatie overweegt, en een directe lekkage-melder voor wie acuut een probleem heeft. Die scheiding zorgt dat urgente meldingen niet verdwijnen tussen algemene aanvragen, en dat elke bezoeker precies het formulier krijgt dat bij zijn situatie past.\n\nHet resultaat is een website die zowel de rust van een gepland project als de spoed van een lekkage moeiteloos opvangt, en die het vakmanschap van Feigro net zo stevig neerzet als de daken die ze opleveren."
    }
  },
  {
