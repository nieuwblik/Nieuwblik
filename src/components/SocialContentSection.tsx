...
const SocialContentSection = () => {
  ...
  const videos = [{
    ...
    id: "0FSEJxlDNpk",
    title: "Social Content 5"
  }];
  return <section className="py-20 px-4 bg-gradient-to-b from-background to-muted/20">
      <div className="max-w-7xl mx-auto">
        <div ref={sectionAnimation.ref} className={`text-center mb-16 transition-all duration-1000 ${sectionAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
