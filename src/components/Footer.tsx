      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
                ...
                <div className="flex gap-3">
                  {socialLinks.map((social, index) => (
                    <motion.a 
                      ...
                      style={social.bgColor ? { backgroundColor: social.bgColor } : {}}
          ...
          <motion.div
            ...
            transition={{ delay: 0.1, duration: 0.6, ease: easings.easeOutExpo }}
          >
            ...
            <ul className="space-y-2 text-sm">
              {navigationLinks.map((link, index) => (
                <motion.li 
                  ...
                  transition={{ delay: 0.2 + index * 0.05, duration: 0.4, ease: easings.easeOutExpo }}
                >
                  <Link 
                    to={link.to} 
            ...
            <ul className="space-y-2 text-sm">
              {legalLinks.map((link, index) => (
                <motion.li 
                  ...
                  initial={{ opacity: 0, x: -15 }}
                  animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -15 }}
                  transition={{ delay: 0.3 + index * 0.05, duration: 0.4, ease: easings.easeOutExpo }}
                >
                  <Link 
                    to={link.to} 
                    className="text-muted-foreground hover:text-foreground transition-colors inline-block"
          ...
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 40 }}
            transition={{ delay: 0.3, duration: 0.6, ease: easings.easeOutExpo }}
          >
          ...
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 40 }}
            transition={{ delay: 0.4, duration: 0.6, ease: easings.easeOutExpo }}
          >
