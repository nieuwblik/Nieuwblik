      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          ease: easings.easeOutExpo
            ...
            <OptimizedImage src={logo} alt={`${companyInfo.name} logo`} className="h-8 mb-4 brightness-0" type="logo" width={150} height={32} />
            <p className="text-muted-foreground text-sm mb-6">
              Wij zijn {companyInfo.name}, jouw partner in digitale groei. Met passie en expertise creëren we websites en designs die niet alleen prachtig zijn, maar ook echt resultaat opleveren.
            </p>
          ...
          ease: easings.easeOutExpo
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href={companyInfo.address.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                  {companyInfo.address.street}<br />{companyInfo.address.postalCode} {companyInfo.address.city}
                </a>
              </li>
              <li>KVK: {companyInfo.kvk}</li>
              <li>BTW: {companyInfo.btw}</li>
            </ul>
          </motion.div>
        ...
        ease: easings.easeOutExpo
          ...
          <p>© {new Date().getFullYear()} {companyInfo.name}. Alle rechten voorbehouden.</p>
        </motion.div>
      </div>
    </footer>;
};
